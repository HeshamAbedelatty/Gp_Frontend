...
// import 'package:final_profile/test.dart';
...
'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzIxNzgyOTQ1LCJpYXQiOjE3MjA0ODY5NDUsImp0aSI6ImUyNzQ5YjM0NTljNjRhMWM4MjI3ODcwY2JjMTBhODk4IiwidXNlcl9pZCI6NX0.ynFan0aQ6AKZ0YvZe4tDtxbprW2oKBVQsygseZwG1rA';
...
class LibraryModel extends ChangeNotifier {
  ...
  Future<void> pickAndUploadFile(int folderId) async {
    // try {
      ...
      request.files.add(
        await http.MultipartFile.fromPath(
          'media_path', // Server-side form field name for file
          file.path,
          filename: fileName,
        ),
      );
 // Add file_type to request
      request.fields['file_type'] = 'pdf'; // Assuming file_type is 'text'
...
// const String accessToken =
// 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzIxNzgyOTQ1LCJpYXQiOjE3MjA0ODY5NDUsImp0aSI6ImUyNzQ5YjM0NTljNjRhMWM4MjI3ODcwY2JjMTBhODk4IiwidXNlcl9pZCI6NX0.ynFan0aQ6AKZ0YvZe4tDtxbprW2oKBVQsygseZwG1rA';
//     // 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzIxNzc4Mjk1LCJpYXQiOjE3MjA0ODIyOTUsImp0aSI6IjczMDJlZDg3NGVhNTQyOWY4ZTFlNTIzMzE5ZWZiZGQzIiwidXNlcl9pZCI6Mjd9.t2izweROe6r67NLE-MMJTbQTsrLjruJPhLh41Lo3myg';
...
//       if (result != null) {
//         File file = File(result.files.single.path!);
//         String fileName = result.files.single.name ?? 'file';
...
//           FileItem fileItem = FileItem(
//             id: jsonResponse['id'],
//             mediaPath: jsonResponse['media_path'] ?? '',
...
// class FolderDetailPage extends StatelessWidget {
//   final Folder folder;
//   final Color folderColor = Colors.green;
//   int num = 0;
...
//                       leading: Icon(
//                         Icons.insert_drive_file,
//                         color: Colors.red, // Set file icon color to red
//                       ),
//                       title: Text(extractFileName(file.mediaPath)),
//                       trailing: IconButton(
//                         icon: Icon(Icons.open_in_new),
