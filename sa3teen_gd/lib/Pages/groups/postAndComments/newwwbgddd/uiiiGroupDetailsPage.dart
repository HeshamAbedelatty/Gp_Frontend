...
class _PostListState extends State<PostList> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() =>
        Provider.of<PostProvider>(context, listen: false).fetchPosts(widget.groupId));
  }
  Future<void> likePost(int postid, int groupId) async {
    
    final url = 'http://10.0.2.1:8000/groups/$groupId/posts/${postid}/like/';
    final accessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzIwODIzNjc0LCJpYXQiOjE3MTk1Mjc2NzQsImp0aSI6ImRlODZmMmUwM2RiOTRjOGJiOWQ3ZTVlMTZiYTcwYzY3IiwidXNlcl9pZCI6Mn0.ezPy5Xh-ItL9SH3h9REnioVGgn1WKlDtH-y2un_muGU'; // Replace with your actual access token
                       ...
                       SizedBox(width: 5,),
                        if (!post.userHasLiked)
                          IconButton(
                            ...
                            color: kprimaryColourcream, // Use your preferred color
                        ...
                        if (post.userHasLiked)
                          IconButton(
                            ...
                            onPressed: () { likePost(post.id,widget.groupId);},
                          ),
