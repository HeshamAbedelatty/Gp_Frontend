...
// import 'package:just_audio/just_audio.dart'; // Uncomment if using just_audio package
          ...
          return Card(
            ...
            child: ListTile(
              ...
              subtitle: Column(
                ...
                children: [
                  Text('Duration: ${audio.duration.toString().split('.').first}'),
                  Text('Uploaded: ${audio.uploadedDate.toLocal()}'),
                  Text('Position: ${audio.currentPosition.toString().split('.').first}'),
                ],
              ),
              trailing: Row(
                ...
                children: [
                  IconButton(
                    icon: Icon(audio.isFavorite ? Icons.favorite : Icons.favorite_border),
                    onPressed: () {
