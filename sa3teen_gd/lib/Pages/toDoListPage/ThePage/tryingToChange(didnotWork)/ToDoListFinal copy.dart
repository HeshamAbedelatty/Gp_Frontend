...
//   void addNewToDoList() {
//     setState(() {
//       var listName = listNameController.text;

//       toDoLists
//           .add(ToDoListClass(listName: listName, tasks: []));
...
//                                 TextFormField(
//                                   controller: () {
//                                     if (listNameControllers.isNotEmpty &&
//                                         toDoLists.isNotEmpty) {
//                                       return listNameControllers[
//                                           toDoLists.length - 1];
//                                     } else {
//                                       return TextEditingController();
//                                     }
//                                   }(),
//                                   //34an we ana bktb btt8ir 3ala l screen
//                                   onChanged: (value) {
//                                     if (toDoLists.isNotEmpty) {
//                                       setState(() {
//                                           toDoLists[toDoLists.length -
//                                                   1] //34an yd5l fy l index l 2a2l
//                                               .listName = value;
//                                           print(
