...
// import '../FavouriteGroupsList/FavoriteGroupsPage.dart';
...
//                       context,
//                       MaterialPageRoute(
//                         builder: (context) => FavoriteGroupsPage(favoriteGroups: favoriteGroups),
//                       ),
//                     );
//                   },
//                   child: Text(
...
//                 return GroupCard(
//                   group: groups[index],
//                   isFavorite: favoriteGroups.contains(groups[index]),
...
//   final Function(GroupPage) onFavoriteToggle;

//   GroupCard({required this.group, required this.isFavorite, required this.onFavoriteToggle});
