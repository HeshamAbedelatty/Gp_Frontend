...
// // class getAllGroups {Future<List<listGroupsModel>> getAllProducts(String accessToken) async {
// //   Map<String, String> headers = {
// //     'Authorization': 'Bearer $accessToken',
// //   };
...
//           ElevatedButton(
//               onPressed: () {
//                getAllGroups(). getAllProducts(
//                     'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzIwNjE1ODc5LCJpYXQiOjE3MTkzMTk4NzksImp0aSI6IjBlYTlhMWQ1NTVjNDQzNmZiZDYzN2ExZWY5NDU0ZDQ5IiwidXNlcl9pZCI6NX0.j06_cCptq8jr7D9cbiUoVLJWB_OLzD-4ZASLMDJmtdw');
//               },
